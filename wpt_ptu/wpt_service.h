...
/* (FOR PRU ONLY) To add multiple base UUIDs IRAM1 memory start and length need to be adjusted. 
...
/**@brief Struct representing an instance of the WPT Service
 */
typedef struct 
{	
